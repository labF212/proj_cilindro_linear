...
analog_read1 = board.get_pin('a:1:i') #mudar para a0
analog_read5 = board.get_pin('a:5:i') #mudar para a2    
digital_write3 = board.get_pin('d:9:p') #mudar para d3  prj final d09
digital_write5 = board.get_pin('d:10:p') #mudar no prj final para d10
digital_read1 = board.get_pin('d:2:i') #fim de curso esquerdo
digital_read2 = board.get_pin('d:3:i') #fim de curso direito
...
window = sg.Window('Controlo de velocidade de deslocamento de cilindro', layout, resizable=True, finalize=True)
...
while True:
    ...
    if RawValue1 is not None:
        ...
        valor_medido_sensorAI1 = round((RawValue1 * 38), 2)
        window['-TEMP1-'].update(str(valor_medido_sensorAI1) + ' cm')
